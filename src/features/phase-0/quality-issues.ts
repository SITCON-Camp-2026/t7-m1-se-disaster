...
export function computeSeverityForIssues(
...
export function resolveRecordSeverity(record: {
  qualitySeverity?: string;
  qualityIssues?: string[];
}): "low" | "medium" | "high" {
  if (
    record.qualitySeverity === "low" ||
    record.qualitySeverity === "medium" ||
    record.qualitySeverity === "high"
  ) {
